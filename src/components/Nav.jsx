      ...
      {!isSearchVisible && (
        ...
        >
          <nav className="flex flex-col p-4 space-y-2">
            <a 
              href="#" 
              className={`nav-link text-gray-900 Herotransition-colors duration-200 py-3 px-4 rounded-lg bg-gray-50 hover:bg-gray-100 slide-hover ${activeLink === 'Home' ? 'active bg-gray-200' : ''}`}
              onClick={() => setActiveLink('Home')}
            >
              Home
            </a>
            <a 
              href="#" 
              className={`nav-link text-gray-900 Herotransition-colors duration-200 py-3 px-4 rounded-lg bg-gray-50 hover:bg-gray-100 slide-hover ${activeLink === 'Events' ? 'active bg-gray-200' : ''}`}
              onClick={() => setActiveLink('Events')}
            >
              Events
            </a>
            <a 
              href="#" 
              className={`nav-link text-gray-900 Herotransition-colors duration-200 py-3 px-4 rounded-lg bg-gray-50 hover:bg-gray-100 slide-hover ${activeLink === 'Blog' ? 'active bg-gray-200' : ''}`}
              onClick={() => setActiveLink('Blog')}
            >
              Blog
            </a>
            <a 
              href="#" 
              className={`nav-link text-gray-900 Herotransition-colors duration-200 py-3 px-4 rounded-lg bg-gray-50 hover:bg-gray-100 slide-hover ${activeLink === 'Donation' ? 'active bg-gray-200' : ''}`}
              onClick={() => setActiveLink('Donation')}
            >
              Donation
            </a>
            <a 
              href="#" 
              className={`nav-link text-gray-900 Herotransition-colors duration-200 py-3 px-4 rounded-lg bg-gray-50 hover:bg-gray-100 slide-hover ${activeLink === 'Contacts' ? 'active bg-gray-200' : ''}`}
              onClick={() => setActiveLink('Contacts')}
            >
              Contacts
            </a>
            <button className="bg-[#F66646] text-white px-4 py-3 text-center cursor-pointer hover:bg-[#E24D2B] transition-all duration-200 rounded-lg mt-4 button-hover">
              Donate
            </button>
          </nav>
        </div>
    ...
    {isSearchVisible && (
      ...
      >
        <div className="w-full mx-auto px-2 sm:px-4">
          <div className="flex justify-between items-center h-16 sm:h-20 lg:h-28">
            ...
            <div style={slideInRight}>
              <X
                className="inline-block mr-2 sm:mr-4 cursor-pointer w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-6 font-light opacity-70 transition-all duration-300 ease-in-out hover:opacity-100 hover:rotate-90 hover:scale-110 active:scale-95"
                style={{
                  ...slideInRight,
                  animation: 'rotateSlideIn 0.5s ease-out forwards',
                  animationDelay: slideInRight.animationDelay || '0.3s'
                }}
                onClick={() => {
                  // Add exit animation class
                  const exitAnimation = {
                    animation: 'rotateSlideOut 0.3s ease-in forwards'
                  };
        ...
        <div className="px-4 sm:px-8 md:px-12 lg:px-20 flex items-center relative mt-8 sm:mt-12 lg:mt-16">
          <div className="w-full relative" style={fadeIn}>
            <input 
              ...
              className="w-full outline-none border-b-2 border-b-transparent p-2 sm:p-3 text-lg sm:text-xl lg:text-2xl placeholder:text-xl sm:placeholder:text-2xl lg:placeholder:text-3xl placeholder:text-gray-600/20 pb-3 sm:pb-4 caret-black/70 relative z-10 transition-all duration-200 focus:placeholder:opacity-50"
            />
            {/* Animated border - Fixed to prevent buggy behavior */}
            <div 
          ...
          <Search
            className="inline-block cursor-pointer w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-6 font-light opacity-50 transition-all duration-200 ease-in-out hover:opacity-70 hover:scale-105 active:scale-95 absolute right-4 sm:right-8 md:right-12 lg:right-24 bottom-2 sm:bottom-3"
        ...
        <style jsx>{`
          ...
          /* Fix for buggy border animation */
          .input-border {
            position: absolute;
            bottom: 0;
            left: 0;
          ...
          /* Prevent animation interruption on hover */
          .input-border:not(.animate):hover {
            width: 0;
          }
        `}</style>
      </header>
